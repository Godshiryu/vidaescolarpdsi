...
class DisciplinesControllerTest < ActionController::TestCase
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post :create, discipline: { Course_id: @discipline.Course_id, cargahoraria: @discipline.cargahoraria, nome: @discipline.nome }
    end
  ...
  test "should update discipline" do
    patch :update, id: @discipline, discipline: { Course_id: @discipline.Course_id, cargahoraria: @discipline.cargahoraria, nome: @discipline.nome }
    assert_redirected_to discipline_path(assigns(:discipline))
  end

...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { Activities: @grade.Activities, Users_id: @grade.Users_id, nota: @grade.nota }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { Activities: @grade.Activities, Users_id: @grade.Users_id, nota: @grade.nota }
    assert_redirected_to grade_path(assigns(:grade))
  end
